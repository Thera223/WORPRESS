<?php
function teczilla_it_solutions_inline_css(){
...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#f04c23');               
...
add_action( 'wp_enqueue_scripts', 'teczilla_it_solutions_inline_css',20 );

  function avadant_it_solutions_custom_header_setup()
    {
        add_theme_support('custom-header', apply_filters('avadanta_custom_header_args', array(
            ...
            'height'             => 250,
            'flex-height'        => true,
            'wp-head-callback'   => 'avadanta_it_solutions_header_style',
        )));
    }

    add_action( 'after_setup_theme', 'avadant_it_solutions_custom_header_setup' );


if ( !function_exists('avadanta_it_solutions_header_style') ) :
    /**
     * Add Header And background Images
     */
    function avadanta_it_solutions_header_style()
    {
