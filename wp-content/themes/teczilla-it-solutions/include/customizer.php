<?php
function teczilla_it_solutions_sections_settings( $wp_customize ) {
     ...
     $wp_customize->remove_setting( 'teczilla_menu_item_color' );
      $wp_customize->remove_setting( 'teczilla_menu_item_hover_color' );
       ...
       $wp_customize->remove_setting( 'teczilla_submnubg_scheme' );
        ...
        'default' => esc_html__('#f04c23','teczilla-it-solutions'),
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    
    $wp_customize->add_control(
        new WP_Customize_Color_Control($wp_customize,'teczilla_theme_color_scheme',array(
            'label' => esc_html__('Theme Color','teczilla-it-solutions'),           
            'description' => esc_html__('Change Theme Color','teczilla-it-solutions'),
            'section' => 'colors',
        ...
        $wp_customize->add_control('braedcrumb_height',
            array(
                'label'    => __('Breadcrumb Header Height', 'teczilla-it-solutions'),
    ...
    $wp_customize->add_control('teczilla_header_button',
        array(
            'label'       => esc_html__('Header Button', 'teczilla-it-solutions'),
    ...
    $wp_customize->add_control('teczilla_header_button_url',
        array(
            'label'       => esc_html__('Header Button Url', 'teczilla-it-solutions'),
            'section'     => 'teczilla_top_header',
            'type'        => 'text',
        )
    );
...
add_action( 'customize_register', 'teczilla_it_solutions_sections_settings', 30);