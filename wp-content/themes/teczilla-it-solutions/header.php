...
<div class="wrapper-area">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'teczilla-it-solutions' ); ?></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 shar">
                            <div class="toolbar-sl-share">
                                <?php
                                if(!empty($teczilla_header_address)) { ?>
                                    <i class="fa fa-map-marker"></i><div class="add"><?php echo esc_html($teczilla_header_address); ?></div>
                                    <?php } ?>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-7 text-center">
                                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php echo esc_attr('Top Menu','teczilla-it-solutions'); ?>">
                         ...
                         ?>
                                <ul class="teczilla-add-menu">
                                    <li class="header-menus">
                                        <a href="<?php echo esc_url( admin_url( 'nav-menus.php' ));  ?>"><?php echo esc_html__( 'Add Menu Here', 'teczilla-it-solutions' ); ?>
                                        </a>
                                    </li>
                                </ul>
                                <?php
